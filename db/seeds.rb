...
instrument2.photo.attach(io: file2, filename: 'piano.png', content_type: 'image/png')

file3 = URI.open('http://loremflickr.com/400/400/violon')
instrument3 = Instrument.new(name: 'Violon', category: 'Instrument a corde', brand: 'Stradivarius', age: '5 months', price: '5$', user: alan)
instrument3.photo.attach(io: file3, filename: 'piano.png', content_type: 'image/png')
...
instrument4.photo.attach(io: file4, filename: 'flute.png', content_type: 'image/png')
