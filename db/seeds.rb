...
titou = User.create(email: 'titou@lewagon.com', password: 'password', pseudo: 'Titou')
...
momo = User.create(email: 'momo@lewagon.com', password: 'password', pseudo: 'Momo92i')
...
instrument2 = Instrument.new(name: 'Piano', category: 'Instrument a corde frappées', brand: 'Bechstein', age: '12 months', adress: "36 Rue de la Clef, 59800 Lille", price: '5$', user: momo)
...
instrument3 = Instrument.new(name: 'Violon', category: 'Instrument a corde', brand: 'Stradivarius', age: '5 months', adress: "160 Rue Faventines, 26000 Valence", price: '5$', user: titou)
...
instrument4 = Instrument.new(name: 'Flute', category: 'Instrument a vent en cuivre', brand: 'Cora', age: '1 months', adress: "La Lauvette, 06340 Nice", price: '5$', user: titou)
...
instrument5 = Instrument.new(name: 'Drum', category: 'Instrument percussion', brand: 'Yamaha', age: '7 months', price: '5$', adress: "24 route de Valenciennes, Orsinval", user: momo)
